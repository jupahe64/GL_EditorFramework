...
namespace GL_EditorFramework
{
    public static class Renderers
    {
        ...
        [Obsolete("Use ColorCubeRender instead, it's half the size of ColorBlockRenderer")]
        ...
        public static class ColorCubeRenderer
        {
            private static bool Initialized = false;
            ...
            public static void Initialize()
            {
                if (!Initialized)
                {
                    ...
                    var defaultVert = new VertexShader(
                        ...
                        void main(){
                            fragPosition = position.xyz;
                            uv = map(fragPosition.xz,vec2(-0.5625,-0.5625),vec2(0.5625,0.5625), vec2(0.5,0.5), vec2(0.75,1.0));
                            gl_Position = mtxCam*mtxMdl*position;
                            fragColor = color;
                        }");
                    DefaultShaderProgram = new ShaderProgram(defaultFrag, defaultVert);
